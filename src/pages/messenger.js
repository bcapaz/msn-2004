...
import SpyPanel from '../components/SpyPanel'; // Importação corrigida aqui
...
export default function MessengerPage() {
  ...
  useEffect(() => {
    // Só carrega contatos se não for admin
  ...
  // SE FOR ADMIN, ABRE O PAINEL DE ESPIONAGEM
  if (currentUser.isAdmin) {
    return <SpyPanel currentUser={currentUser} />;
  }
